...
public class PlannerService {
    ...
    public void storeCluster(int plan_id, int day_order, int cluster_order, String name, int id, String start_time, String end_time, double lat, double lng, double rating, String description, String image_url, int average_time_spent, String open, String close, int cost) {
